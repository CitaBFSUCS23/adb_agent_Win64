...
class MainApp:
    ...
    def __init__(self, root):
        ...
        self.screen_cast_window = ScreenCastWindow(root)
        self.screen_cast_window.set_adb_client(self.adb_client)
    ...
    def _toggle_stream(self):
        if self.screen_cast_window and not self.screen_cast_window.stream_active:
            self.screen_cast_window._toggle_stream()

    def _take_screenshot(self):
        if self.screen_cast_window:
            self.screen_cast_window.take_screenshot()
    ...
    def _refresh_language(self):
        ...
        self.screen_cast_window.refresh_ui()
        for pc in self.page_classes.values():
